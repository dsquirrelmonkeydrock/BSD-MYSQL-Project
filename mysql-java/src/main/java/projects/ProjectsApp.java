...
public class ProjectsApp {
    ...
    public static void main(String[] args) {
        new ProjectsApp().processUserSelctions();
    }

    private void processUserSelctions() {
        boolean done = false;
        while (!done) {
            try {
    ...
    private void deleteProject() {
        listProjects();
        Integer projectId = getIntInput("ID of Project to delete");
    ...
    private void updateProjectDetails() {
        ...
        String projectName = getStringInput("Enter the prject name [" + curProject.getProjectName() + "]");
    ...
    private void createProject() {
        ...
        BigDecimal estimatedHours = getDecimalInput("Eter the estimated hours");
